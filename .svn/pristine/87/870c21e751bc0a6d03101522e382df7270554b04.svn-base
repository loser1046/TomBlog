 ...
 #pagelist span{
    ...
    <body>
        ...
        <table class="table table-bordered table-hover definewidth m10">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lvo): $mod = ($i % 2 );++$i;?><tr>
        ...
        <div id="pagelist"><?php echo ($page); ?></div>
    </body>
</html>
