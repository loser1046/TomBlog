...
<link href="__PUBLIC__ . /TomBlogs/css/adminStyle.css" rel="stylesheet" type="text/css" />

<title>MOOC网站管理系统</title>
<script type="text/javascript" src="__PUBLIC__ . /TomBlogs/js/jquery1.js"></script>
...
<body>
	...
	<div class="top2">
		<div class="logo">
			<img src="__PUBLIC__ . /TomBlogs/images/admin_logo.png" title="在哪儿" />
		</div>
		<div class="title" >
			<h3>MOOC网站后台管理系统</h3>
		</div>
	...
	<div class="left">
		<div class="div1">
			<div class="left_top">
				<img src="__PUBLIC__ . /TomBlogs/images/bbb_01.jpg"><img src="__PUBLIC__ . /TomBlogs/images/bbb_02.jpg"
					id="2"><img src="__PUBLIC__ . /TomBlogs/images/bbb_03.jpg"><img
					src="__PUBLIC__ . /TomBlogs/images/bbb_04.jpg">
			</div>
			<div class="div2">
				<div class="spgl"></div>
				文档管理
