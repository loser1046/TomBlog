    ...
    <form action="" method="post">
        ...
        <table class="table table-bordered table-hover definewidth m10" style="margin-left:3%;margin-top:2%;">
            <tr>
                ...
                <td><input type="text" name="bigTypeName" value="<?php echo ($aa[0]['公告标题']); ?>" style="height: 41px; width: 546px"/></td>
            </tr>
            <tr>
                <td class="tableleft">内容</td>
                <td><input type="text" name="typeIntroduce" value="<?php echo ($aa[0]['内容']); ?>" style="height: 93px; width: 546px"/></td>
            </tr> 
            <tr>
                <td class="tableleft">发布时间</td>
                <td style="height: 46px; "> <div style="margin:0 auto;">
                        <input type="text" id="time1" name="published" value="<?php echo ($aa[0]['发布时间']); ?>" onClick="return Calendar('time1');" class="text_time"/>
                    </div> 
                </td>
            </tr> 
            <tr>
                ...
                <td> <div style="margin:0 auto;">
                        <input type="text" id="time2" name="fatime" value="<?php echo ($aa[0]['失效时间']); ?>" onClick="return Calendar('time2');" class="text_time"/>
                    </div> 
                </td>
            </tr>  
            <tr>
                ...
                <td>
                    <button style="margin-left:180px;" type="submit" class="btn btn-primary" type="button">确认修改</button>&nbsp;&nbsp;<a href="<?php echo U('admin/boss/afficheQuery');?>"><button type="button" class="btn btn-success" name="backid" id="backid" onclick=javascrtpt:jump();>返回列表</button></a>
                </td>
            </tr>
        </table>
    </form>
